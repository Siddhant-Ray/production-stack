...
class UserSession:
    ...
    def set_internal_state(self, offset: float, timestamp: float):
        ...
        num_passed_questions = int(offset / self.user_config.gap_between_requests)
        passed_time = num_passed_questions * self.user_config.gap_between_requests
